...
dst_dir = '/home/fu/Documents/vocaloid_modeling/vocaloid_modeling/vocaloid_modeling/data/audio_5s'
...
for file in original_files:
    ...
    data_5s = data[:num_samples]
    
    # Create the full destination file path.
    dst_path = os.path.join(dst_dir, file)
    
    # Write the 5-second clip to the destination.
    sf.write(dst_path, data_5s, samplerate)
    
    print(f'Processed {file}: saved first 5 seconds to {dst_path}')
